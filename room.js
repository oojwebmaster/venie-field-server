...
export class Room {
  ...
  constructor(opt = {}) {
    this.opt = {
      ...
      shellCount: 6,          // 동시에 떠 있는 조개 수
      shellRespawn: 120000,   // 먹히고 다시 나기까지(ms) — 2분
      shellScore: 0,          // 일반 조개의 점수
      pearlScore: 5,          // 진주조개의 점수
      pearlChance: 0.1,       // 새로 나는 조개가 진주조개일 확률
      /* ★ 동시에 존재할 수 있는 진주조개 수. 이미 있으면 **먹을 때까지**
       *   새 진주조개가 나지 않습니다 — '드물다'를 확률만으로 두면 운이
       *   나쁜 날에는 해변에 진주가 셋 널려 있게 됩니다. */
      pearlMax: 1,
