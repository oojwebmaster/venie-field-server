 ...
 * 파스텔 톤 — 진하지 않게, 다만 채도가 너무 낮으면 잔디 위에서 안 보입니다.
 */
export const WHEEL = [
  { deg: 0, hex: '#f58a8a' },     // 빨강
  { deg: 30, hex: '#f79c82' },
  { deg: 60, hex: '#f7b27a' },    // 주황
  { deg: 90, hex: '#f6cb80' },
  { deg: 120, hex: '#f5de85' },   // 노랑
  { deg: 150, hex: '#c2de8c' },
  { deg: 180, hex: '#96d9a0' },   // 초록
  { deg: 210, hex: '#86d2cc' },
  { deg: 240, hex: '#8cc1ec' },   // 파랑
  { deg: 268, hex: '#9aa3e0' },   // 남색
  { deg: 300, hex: '#c79be0' },   // 보라
  { deg: 330, hex: '#ee9bc4' },
];
