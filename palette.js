...
/* ── 진주색 ────────────────────────────────────────────────────────────────
 * ★ 이 색은 **색상환 위에 없습니다.** 진주는 물감이 아니라서 섞이지 않고,
 *   무슨 색이 묻어 있든 덮어씁니다(요구사항). 그래서 { h, s }가 아니라
 *   문자열 하나로 둡니다 — 섞기 계산에 들어갈 여지 자체를 없앤 것입니다.
 *
 * ★ 순백(#ffffff)은 쓰지 않습니다. 이 게임의 배경이 흰 하늘·밝은 모래라
 *   순백 베니는 배경에 묻혀 실루엣이 사라집니다. 아주 옅은 따뜻한 상아색이면
 *   '진주'로 읽히면서 형태도 남습니다. 더 분홍빛으로 하려면 b를 조금 낮추세요. */
export const PEARL = '#f2e7da';
